...
/*        SieveRecipeBuilder.sieve(PoBlocks.POOP_BLOCK, 200)
    ...
    private static void primoWoodRecipes(RecipeOutput recipeOutput) {
        provider.shapeless(RecipeCategory.BUILDING_BLOCKS, PoBlocks.PRIMO_PLANKS, 4)
                .requires(PoTags.Items.PRIMO_STEMS)
                .unlockedBy("has_primo_logs", has(PoTags.Items.PRIMO_STEMS))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.BUILDING_BLOCKS, PoBlocks.PRIMO_HYPHAE, 3)
                .pattern("LL")
                .pattern("LL")
                .define('L', PoBlocks.PRIMO_STEM)
                .unlockedBy(getItemName(PoBlocks.PRIMO_STEM), has(PoBlocks.PRIMO_STEM))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.BUILDING_BLOCKS, PoBlocks.STRIPPED_PRIMO_HYPHAE, 3)
                .pattern("LL")
                .pattern("LL")
                ...
                .save(recipeOutput);
        provider.shaped(RecipeCategory.BUILDING_BLOCKS, PoBlocks.PRIMO_STAIRS, 4)
                .pattern("P  ")
                .pattern("PP ")
                .pattern("PPP")
                ...
                .save(recipeOutput);
        provider.shaped(RecipeCategory.BUILDING_BLOCKS, PoBlocks.PRIMO_SLAB, 6)
                .pattern("PPP")
                .define('P', PoBlocks.PRIMO_PLANKS)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.BUILDING_BLOCKS, PoBlocks.PRIMO_VERTICAL_SLAB, 6)
                .pattern("P")
                .pattern("P")
                .pattern("P")
                .define('P', PoBlocks.PRIMO_PLANKS)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
                .save(recipeOutput);
        provider.shapeless(RecipeCategory.REDSTONE, PoBlocks.PRIMO_BUTTON)
                .requires(PoBlocks.PRIMO_PLANKS)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.REDSTONE, PoBlocks.PRIMO_PRESSURE_PLATE)
                .pattern("PP")
                .define('P', PoBlocks.PRIMO_PLANKS)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.DECORATIONS, PoBlocks.PRIMO_FENCE, 3)
                .pattern("PSP")
                .pattern("PSP")
                .define('P', PoBlocks.PRIMO_PLANKS)
                .define('S', Items.STICK)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.REDSTONE, PoBlocks.PRIMO_FENCE_GATE)
                .pattern("SPS")
                .pattern("SPS")
                .define('P', PoBlocks.PRIMO_PLANKS)
                .define('S', Items.STICK)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.REDSTONE, PoBlocks.PRIMO_DOOR, 3)
                .pattern("PP")
                .pattern("PP")
                .pattern("PP")
                .define('P', PoBlocks.PRIMO_PLANKS)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
                .save(recipeOutput);
        provider.shaped(RecipeCategory.REDSTONE, PoBlocks.PRIMO_TRAPDOOR, 2)
                .pattern("PPP")
                .pattern("PPP")
                .define('P', PoBlocks.PRIMO_PLANKS)
                .unlockedBy(getItemName(PoBlocks.PRIMO_PLANKS), has(PoBlocks.PRIMO_PLANKS))
