...
import com.altnoir.poopsky.common.entity.p.WitherPoopBall;
...
public class WitherPoopBallItem extends Item implements ProjectileItem {
    public WitherPoopBallItem(Properties properties) {
        super(properties);
    }
