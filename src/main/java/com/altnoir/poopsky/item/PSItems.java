...
public class PSItems {
    ...
    public static final Item MAGGOTS_SEEDS = registerItem("maggots_seeds",
            new AliasedBlockItem(PSBlocks.MAGGOTS, new Item.Settings()));//这地方太神必了，把PSBlocks.MAGGOTS换成原版的Blocks.POTATOES就正常了，换成自定义的就崩溃
