...
public class PlacerMenu extends AbstractContainerMenu {
    ...
    public PlacerMenu(int containerId, Inventory playerInventory) {
        this(containerId, playerInventory, new SimpleContainer(9));
    }

    public PlacerMenu(int containerId, Inventory playerInventory, Container container) {
        super(MenuType.GENERIC_3x3, containerId);
        checkContainerSize(container, 9);
        this.placer = container;
    ...
    public boolean stillValid(Player player) {
        return this.placer.stillValid(player);
    }
