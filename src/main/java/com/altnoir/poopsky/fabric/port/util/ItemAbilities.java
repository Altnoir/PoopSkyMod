...
public class ItemAbilities {
    ...
    /**
     * Passed onto {@link com.altnoir.poopsky.fabric.port.extension.IBlockExtension#getToolModifiedState} when an axe wants to strip a log
     */
    public static final ItemAbility AXE_STRIP = ItemAbility.get("axe_strip");

    /**
     * Passed onto {@link com.altnoir.poopsky.fabric.port.extension.IBlockExtension#getToolModifiedState} when an axe wants to scrape oxidization off copper
     */
    public static final ItemAbility AXE_SCRAPE = ItemAbility.get("axe_scrape");

    /**
     * Passed onto {@link com.altnoir.poopsky.fabric.port.extension.IBlockExtension#getToolModifiedState} when an axe wants to remove wax out of copper
     */
    public static final ItemAbility AXE_WAX_OFF = ItemAbility.get("axe_wax_off");

    /**
     * Passed onto {@link com.altnoir.poopsky.fabric.port.extension.IBlockExtension#getToolModifiedState} when a shovel wants to turn dirt into path
     */
    public static final ItemAbility SHOVEL_FLATTEN = ItemAbility.get("shovel_flatten");

    /**
     * Passed onto {@link com.altnoir.poopsky.fabric.port.extension.IBlockExtension#getToolModifiedState} when a shovel wants to douse a campfire
     */
    ...
    /**
     * Passed onto {@link com.altnoir.poopsky.fabric.port.extension.IBlockExtension#getToolModifiedState} when a hoe wants to turn dirt into soil
     */
    ...
    /**
     * Passed onto {@link com.altnoir.poopsky.fabric.port.extension.IBlockExtension#getToolModifiedState} when flint and steel or fire charge want to light a campfire/candle/cake.
