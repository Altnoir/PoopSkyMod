...
public class FanDigestingCategory extends ProcessingViaFanCategory.MultiOutput<DigestingRecipe> {
    ...
    public static final IRecipeHolderType<Recipe<?>> TYPE = IRecipeHolderType.create(PSRecipeTypes.DIGESTING.getId());
    ...
    private static List<RecipeHolder<DigestingRecipe>> getAllRecipes() {
        return PSJeiRecipeCache.getAll(PSRecipeTypes.DIGESTING.getType());
    }
}
