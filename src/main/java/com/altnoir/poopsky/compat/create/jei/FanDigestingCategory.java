package com.altnoir.poopsky.compat.create.jei;

import com.altnoir.poopsky.PoopSky;
import com.altnoir.poopsky.compat.create.PSRecipeTypes;
import com.altnoir.poopsky.compat.create.jei.animations.AnimatedUrineLiquid;
...
public class FanDigestingCategory extends ProcessingViaFanCategory.MultiOutput<DigestingRecipe> {
    ...
    public static FanDigestingCategory create() {
        ...
        var icon = new DoubleItemIcon(AllItems.PROPELLER::asStack, () -> new ItemStack(com.altnoir.poopsky.item.PItems.URINE_BUCKET.get()));
