...
public final class PoSectionedCreativeModeTab extends CreativeModeTab {
    ...
    private PoSectionedCreativeModeTab(Builder builder, List<PoCreativeTabSection> sections, Consumer<ItemDisplayParameters> populator) {
        super(builder.row, builder.column, builder.type, builder.displayName, builder.iconGenerator,
                builder.displayItemsGenerator);
        alignedRight = builder.alignedRight;
        showTitle = builder.showTitle;
        canScroll = builder.canScroll;
        backgroundTexture = builder.backgroundTexture;
        this.sections = List.copyOf(sections);
        this.populator = populator;
    }

    public static PoSectionedCreativeModeTab create(Builder builder, Consumer<ItemDisplayParameters> populator,
                                                     PoCreativeTabSection... sections) {
        List<PoCreativeTabSection> sectionList = List.of(sections);
        return new PoSectionedCreativeModeTab(builder, sectionList, populator);
    }
