...
public final class PoSectionedCreativeModeTab extends CreativeModeTab {
    ...
    private PoSectionedCreativeModeTab(Builder builder, List<PoCreativeTabSection> sections, Runnable populator) {
        super(builder);
        this.sections = List.copyOf(sections);
        this.populator = populator;
    }

    public static Builder configure(Builder builder, Runnable populator, PoCreativeTabSection... sections) {
