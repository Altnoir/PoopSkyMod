...
public class ClientPongGame extends ClientGame {
    ...
    public void applySnapshot(CompoundTag tag) {
        ...
        double newPlayerY = tag.getDoubleOr("playerY", 0.0);
        double newOpponentY = tag.getDoubleOr("opponentY", 0.0);
        double newBallX = tag.getDoubleOr("ballX", 0.0);
        double newBallY = tag.getDoubleOr("ballY", 0.0);
        int newBallTimer = tag.getIntOr("ballTimer", 0);
    ...
    private void renderScore(GuiGraphicsExtractor graphics, int posX, int posY, int score, boolean left) {
