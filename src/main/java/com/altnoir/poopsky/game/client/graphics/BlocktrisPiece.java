...
public class BlocktrisPiece {
    ...
    public void renderCentered(GuiGraphicsExtractor graphics, int posX, int posY) {
    ...
    private void render(GuiGraphicsExtractor graphics, int posX, int posY, float offsetX, float offsetY) {
