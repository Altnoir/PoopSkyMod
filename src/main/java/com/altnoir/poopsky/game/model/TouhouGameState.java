...
public final class TouhouGameState {
    ...
    public void applySnapshot(CompoundTag tag) {
        ...
        enemyBullets.clear();
        int enemyCount = tag.getIntOr("enemyBulletCount", 0);
        for (int i = 0; i < enemyCount; i++) {
            enemyBullets.add(new Bullet(
                    tag.getFloatOr("enemyBulletX" + i, 0.0F),
                    tag.getFloatOr("enemyBulletY" + i, 0.0F),
                    tag.getFloatOr("enemyBulletVX" + i, 0.0F),
        ...
        playerBullets.clear();
        int playerCount = tag.getIntOr("playerBulletCount", 0);
        for (int i = 0; i < playerCount; i++) {
            playerBullets.add(new Bullet(
                    tag.getFloatOr("playerBulletX" + i, 0.0F),
                    tag.getFloatOr("playerBulletY" + i, 0.0F),
                    tag.getFloatOr("playerBulletVX" + i, 0.0F),
