...
public class ToiletPlugEntityRenderer extends EntityRenderer<ToiletPlugEntity> {
    private final ToiletPlugModel toiletPlugModel = new ToiletPlugModel();
    public ToiletPlugEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
    }
    @Override
