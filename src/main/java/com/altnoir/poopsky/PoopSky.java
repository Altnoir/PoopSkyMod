...
public class PoopSky implements ModInitializer {
	...
	public void onInitialize() {
		...
		FuelRegistryEvents.BUILD.register((builder, context) -> {
			builder.add(PSItems.POOP, 200);
			builder.add(PSItems.POOP_BALL, 400);
			builder.add(PSBlocks.POOP_SAPLING, 200);
			builder.add(PSBlocks.POOP_LEAVES, 200);
			builder.add(PSBlocks.POOP_BLOCK, 800);
			builder.add(PSBlocks.POOP_STAIRS, 800);
			builder.add(PSBlocks.POOP_SLAB, 400);
			builder.add(PSBlocks.POOP_VERTICAL_SLAB, 400);
			builder.add(PSBlocks.POOP_BUTTON, 200);
			builder.add(PSBlocks.POOP_PRESSURE_PLATE, 400);
			builder.add(PSBlocks.POOP_FENCE, 800);
			builder.add(PSBlocks.POOP_FENCE_GATE, 800);
			builder.add(PSBlocks.POOP_WALL, 800);
			builder.add(PSBlocks.POOP_DOOR, 800);
			builder.add(PSBlocks.POOP_TRAPDOOR, 800);
			builder.add(PSBlocks.POOP_LOG, 800);
			builder.add(PSBlocks.STRIPPED_POOP_LOG, 800);
			builder.add(PSBlocks.POOP_PIECE, 400);
			builder.add(PSBlocks.STOOL, 800);
		});
