...
public class PoopPiece extends Block {
    public static final MapCodec<PoopPiece> CODEC = createCodec(PoopPiece::new);
    ...
    @Override
    public MapCodec<PoopPiece> getCodec() {
        return CODEC;
    }

    public PoopPiece(AbstractBlock.Settings settings) {
        super(settings);
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return blockState.isIn(BlockTags.SNOW_LAYER_CAN_SURVIVE_ON) ? true : Block.isFaceFullSquare(blockState.getCollisionShape(world, pos.down()), Direction.UP) || blockState.isOf(this) && (Integer)blockState.get(LAYERS) == 8;
    }
