...
public class PoopPiece extends Block {
    ...
    protected boolean canPlaceAt(BlockState state, WorldView world, BlockPos pos) {
        ...
        return blockState.isIn(BlockTags.SNOW_LAYER_CAN_SURVIVE_ON) || Block.isFaceFullSquare(blockState.getCollisionShape(world, pos.down()), Direction.UP) || blockState.isOf(this) && (Integer) blockState.get(LAYERS) == 8;
    }
