...
public class OmenSmithingTemplateItem extends SmithingTemplateItem {
    ...
    static {
        ...
        INGREDIENTS_TITLE = Component.translatable(Util.makeDescriptionId("item", AbyssLib.mcloc("smithing_template.ingredients"))).withStyle(TITLE_FORMAT);
        APPLIES_TO_TITLE = Component.translatable(Util.makeDescriptionId("item", AbyssLib.mcloc("smithing_template.applies_to"))).withStyle(TITLE_FORMAT);
        ...
        EMPTY_SLOT_HELMET = AbyssLib.mcloc("item/empty_armor_slot_helmet");
        EMPTY_SLOT_CHESTPLATE = AbyssLib.mcloc("item/empty_armor_slot_chestplate");
        EMPTY_SLOT_LEGGINGS = AbyssLib.mcloc("item/empty_armor_slot_leggings");
        EMPTY_SLOT_BOOTS = AbyssLib.mcloc("item/empty_armor_slot_boots");
        EMPTY_SLOT_HOE = AbyssLib.mcloc("item/empty_slot_hoe");
        EMPTY_SLOT_AXE = AbyssLib.mcloc("item/empty_slot_axe");
        EMPTY_SLOT_SWORD = AbyssLib.mcloc("item/empty_slot_sword");
        EMPTY_SLOT_SHOVEL = AbyssLib.mcloc("item/empty_slot_shovel");
        EMPTY_SLOT_PICKAXE = AbyssLib.mcloc("item/empty_slot_pickaxe");
        EMPTY_SLOT_INGOT = AbyssLib.mcloc("item/empty_slot_ingot");
    }
}
