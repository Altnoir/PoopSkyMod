...
public class ArcadeScreenBlockEntityRenderer implements BlockEntityRenderer<ArcadeBlockEntity> {
    ...
    public ArcadeScreenBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
    }
